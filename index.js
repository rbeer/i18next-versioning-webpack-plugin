...
class I18nextVersioningPlugin {
    ...
    Object.keys(generated).forEach((langKey) => {
      ...
      if (!loaded[langKey]) {
        I18nextVersioningPlugin.logger
          .info(`Initializing new language ${langKey} with version ${generated[langKey].version}`);
        return;
      }
      ...
      if (loaded[langKey].hash !== generated[langKey].hash) {
        ...
        I18nextVersioningPlugin.logger
          .info(`Incremented '${langKey}' to ${generated[langKey].version}`);
      } else {
        I18nextVersioningPlugin.logger
          .info(`Leaving '${langKey}'   at ${generated[langKey].version}`);
      }
    });
  }
  ...
  apply(compiler) {
    ...
    // no need to get `compiler` from the callback;
    // it's the same object as passed to .apply
